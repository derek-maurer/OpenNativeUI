  ...
  return (
    <Modal visible={visible} onClose={onClose} width="max-w-sm">
      <div className="px-4 py-3 border-b border-line-strong">
        <h3 className="text-sm font-semibold text-fg">Add to Folder</h3>
      </div>
      <div className="max-h-80 overflow-y-auto p-2">
        ...
        >
          <MinusCircle size={16} className="text-secondary" />
          <span className="flex-1 text-sm text-secondary">No folder</span>
        ...
        {folders.map((folder) => {
          ...
          return (
            ...
            >
              ...
              <span className="flex-1 truncate text-sm text-fg">{folder.name}</span>
