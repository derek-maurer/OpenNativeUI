  ...
  return (
    <div className="flex flex-col items-center justify-center h-full px-8 pb-12 select-none">
      ...
      <div className="mb-8 text-center">
        <h1 className="text-2xl font-semibold text-white mb-1">{heading}</h1>
      ...
      <div className="grid grid-cols-2 gap-2 w-full max-w-lg">
        {SHOWN.map((text) => (
          <button
            ...
            className="text-left rounded-xl border border-neutral-800 bg-neutral-900 hover:bg-neutral-800 hover:border-neutral-700 px-4 py-3 text-xs text-neutral-400 hover:text-neutral-200 transition-colors leading-relaxed"
          >
            {text}
          </button>
        ))}
